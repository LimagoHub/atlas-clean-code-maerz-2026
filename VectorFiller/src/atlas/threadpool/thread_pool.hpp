...
// =============================================================================
// thread_pool class
// Source: "A C++17 Thread Pool for High-Performance Scientific Computing"
//         Barak Shoshany, arXiv:2105.00613v1, May 2021
//         https://github.com/bshoshany/thread-pool
// =============================================================================

namespace atlas::threadpool {
    class thread_pool
    {
    ...
    public:
         ...
         *
         * @param _thread_count The number of threads to use. The default value is
         * the total number of hardware threads available, as reported by the
         * implementation. With a hyperthreaded CPU, this will be twice the number
         * of CPU cores. If the argument is zero, the default value will be used
         * instead.
         */
         ...
         * executing. The loop will be equivalent to:
         ...
         *             the loop index.
         * @param num_tasks The maximum number of tasks to split the loop into. The
        ...
        void parallelize_loop(T first_index, T last_index, const F &loop, ui32 num_tasks = 0)
        {
            ...
            for (ui32 t = 0; t < num_tasks; t++)
            {
                ...
                T end = (t == num_tasks - 1) ? last_index
         ...
         * @details The function is wrapped inside a lambda in order to hide the arguments,
         * as the tasks in the queue must be of type std::function<void()>, so they cannot
         * have any arguments or return value. If no arguments are provided, the other
         * overload will be used, in order to avoid the (slight) overhead of using a lambda.
         *
         * @tparam F The type of the function.
         ...
         *
         * @param _thread_count The number of threads to use. The default value is
         * the total number of hardware threads available. If zero, the default is used.
         */
         ...
         * into the task queue, and get an std::future<bool> that will be set to
         ...
         * the queue. To wait for a specific task, use submit() instead, and call
        ...
        /**
         * @brief The duration, in microseconds, that the worker function should
         * sleep for when it cannot find any tasks in the queue. If set to 0, then
         * instead of sleeping, the worker function will execute
         * std::this_thread::yield() if there are no tasks in the queue.
    ...
    // =============================================================================
    // synced_stream helper class (optional)
    // Synchronizes printing to an output stream from multiple threads.
    // =============================================================================
